...
<div class="container-fluid">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            ...
            <button type="button" class="btn btn-success right" style="float:right;" id="btn_user_add"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuovo utente</button>
        </div>
