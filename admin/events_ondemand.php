...
$(document).ready(function()
{
        ...
        if (confirm("Vuoi davvero eliminare tutti i video selezionati?"))
	{
		...
		function(data,status)
		{
		    alert("Data: " + data + "\nStatus: " + status + "\nVideo element: " + $(this).children(".video_element").attr('class'));
                    var ul_video_obj = $(this).children(".video_element");
...
try
{
    ...
    echo '<div class="panel panel-default">';
        ...
        echo '<div class="panel-heading">';
            ...
            echo '<button type="button" class="btn btn-danger" style="display:inline; vertical-align:middle; margin-right:4px" id="btn_video_delete">Elimina video</button>';
