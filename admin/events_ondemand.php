                                                ...
                                                while($row = mysql_fetch_array($ondemand_events))
                                                {
                                                        ...
                                                        echo '<li class="list-group-item video_list_element">';
                                                            ...
                                                            echo '<div class="row">';
                                                                ...
                                                                // CHECKBOX
                                                                echo '<div class="col-md-1" style="height:50px; float: none; display:inline-block; vertical-align:middle;">';
                                                                    echo '<input type="checkbox" id="checkbox"/>';
                                                                echo '</div>';

                                                                // VIDEO THUMBNAIL + INFO + BUTTONS
                                                                echo '<div class="col-md-10" style="height:120px; float: none; display:inline-block; vertical-align:middle;">';
