...
/*** FINE MEMBERS ***/
	...
	$user_id = $this->SaveUserDataIntoDatabase($uservars);
        ...
        $mailBody = '<html><body>'.
            'Ciao caro fratello <b>'.$this->UserFullName().'</b>, <br/><br/>'.
            'Un nuovo utente è stato creato. Di seguito puoi vedere le sue credenziali:<br/><br/>'.
    ...
    function CollectRegistrationSubmission(&$uservars)
    {
        ...
        $uservars['email'] = isset($_POST['email']) ? $this->utilsInstance->Sanitize($_POST['email']) : NULL;
